...
def train_model(config_path, fold_nums):
    ...
    for i in fold_nums:
        ...
        train = pl.Trainer(
            ...
            # resume_from_checkpoint="../experiments/LSTMDpRelu-Transformer-concat-skip-classify-smooth-CE-dp-0.4/fold_0/model-epoch=38-val_MAE=0.2282-val_loss=0.0000.ckpt",
            # precision=precision,
            deterministic=True,
