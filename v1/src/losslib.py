...
from torch.nn import L1Loss, SmoothL1Loss, CrossEntropyLoss
from torch import Tensor


__all__ = ["FocalLoss", "CrossEntropyLoss", "SmoothL1Loss", "L1Loss"]
...
class FocalLoss2(nn.Module):
    ...
    def forward(self, x: Tensor, y: Tensor) -> Tensor:
        ...
        focal_loss = (
            self.alpha * (1 - pt) ** self.gamma * ce_loss
        ).mean()  # mean over the batch
        return focal_loss
